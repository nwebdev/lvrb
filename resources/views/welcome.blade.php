  ...
  <!--  <div class="col-lg-5 col-md-5 offset-1">
    ...
    <div class="col-lg-5 col-md-5 mt-4 m-auto ">
      <div class="login-block p-5"> 
        <div class="logo-box pt-3 pb-4 text-center"><img src="assets/images/logo.png" alt="" class="img-fluid" width="201" height="80"/></div>
        ...
        <div class="form-group text-center mt-5"><a href="book-now.html" class="btn-main ">Log In</a></div>
      </div>
...
<div class="container pt-5">
  <div class="col-md-12 mt-5"> <a href="#" class="login-cir pull-right" data-toggle="modal" data-target="#feedback" data-toggle="tooltip" title="Concierge"><img src="assets/images/icon/chat.png" /></a> <a href="#" class="login-cir pull-right"><img src="assets/images/icon/home.png" /></a>
